...
do {
    ...
    for (c = 0; c < round; c++) {
        console.log('\nEscolha uma opção:\n');
        console.log(
            '   \033[0;33mPEDRA\033[0;0m   ---    PAPEL  ---  \033[1;90mTESOURA\033[0;0m\n',
        );
        ...
        if (
            ...
            //verificando o que o usuario digitou se é pedra, papel ou tesoura.
            ...
            if (
                (randon[b] == 3 && option[a] == 'PEDRA') ||
                (randon[b] == 1 && option[a] == 'PAPEL') ||
                (randon[b] == 2 && option[a] == 'TESOURA')
            ) {
                //comparando a opção que o usuario escolheu e o numero aleatorio que foi gerado pelo Math.randon.

                retornoVish = nameComputer(randon[b]); //Chamando a função para trocar o valor do Math.randon de numero par uma palavra.
                console.log('\nJooookeeeennnpoooô!');
                console.log(
                    '\nComputador: \033[1;31m' +
                        retornoVish +
                        '\033[0;0m <---> Jogador : \033[1;32m' +
                        option[a] +
                        '\033[0;0m',
                );
            ...
            if (
                (randon[b] == 1 && option[a] == 'TESOURA') ||
                (randon[b] == 2 && option[a] == 'PEDRA') ||
                (randon[b] == 3 && option[a] == 'PAPEL')
            ) {
                //comparando a opção que o usuario escolheu e o numero aleatorio que foi gerado pelo Math.randon.
                ...
                console.log('\nJooookeeeennnpoooô!');
                console.log(
                    '\nComputador: \033[1;32m' +
                        retornoVish +
                        '\033[0;0m <---> Jogador : \033[1;31m' +
                        option[a] +
                        '\033[0;0m',
                );
            ...
            if (
                (randon[b] == 1 && option[a] == 'PEDRA') ||
                (randon[b] == 2 && option[a] == 'PAPEL') ||
                (randon[b] == 3 && option[a] == 'TESOURA')
            ) {
                //comparando a opção que o usuario escolheu e o numero aleatorio que foi gerado pelo Math.randon.
                ...
                console.log('\nJooookeeeennnpoooô!');
                console.log(
                    '\nComputador: \033[1;34m' +
                        retornoVish +
                        '\033[0;0m <---> Jogador : \033[1;34m' +
                        option[a] +
                        '\033[0;0m',
                );
...
if (winnerPlayer > winnerComputer) {
    console.log(
        'O \033[1;93mJogador\033[0;0m é o \033[1;93mGRANDE VENCEDOR !!!!\033[0;0m ',
    );
} else if (winnerComputer > winnerPlayer) {
    console.log(
        'O \033[1;93mComputador\033[0;0m é o \033[1;93mGRANDE VENCEDOR !!!!\033[0;0m ',
    );
} else {
